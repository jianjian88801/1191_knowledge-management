    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="知识标题" prop="zhishibiaoti">
          <el-input v-model="ruleForm.zhishibiaoti" 
              placeholder="知识标题" clearable  :readonly="ro.zhishibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="知识标题" prop="zhishibiaoti">
              <el-input v-model="ruleForm.zhishibiaoti" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="知识分类" prop="zhishifenlei">
          <el-select v-model="ruleForm.zhishifenlei" placeholder="请选择知识分类">
            <el-option
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="知识附件" prop="zhishifujian">
          <file-upload
          tip="点击上传知识附件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhishifujian" label="知识附件" prop="zhishifujian">
            <el-button type="text" size="small" @click="download(ruleForm.zhishifujian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zhishineirong = this.ruleForm.zhishineirong.replace(reg,'../../../springbootuaaa4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
